...
model_cc_tmp_stream<<col.colName_;
	model_cc_tmp_stream << " = \"";
model_cc_tmp_stream<<escapeIdentifier(col.colName_, rdbms);
	model_cc_tmp_stream << "\";\n";
}
...
model_cc_tmp_stream<<escapeIdentifier(model_cc_view_data.get<std::string>("tableName"), rdbms);
	model_cc_tmp_stream << "\";\n";
model_cc_tmp_stream<<"\n";
...
model_cc_tmp_stream<<col.colName_;
	...
	model_cc_tmp_stream << "}\n";
model_cc_tmp_stream<<"\n";
	model_cc_tmp_stream << "std::string ";
{
    auto & val=model_cc_view_data["className"];
    if(val.type()==typeid(const char *)){
        model_cc_tmp_stream<<*(std::any_cast<const char *>(&val));
	...
	model_cc_tmp_stream << "::toString() const\n";
	model_cc_tmp_stream << "{\n";
	model_cc_tmp_stream << "    return toJson().toStyledString();\n";
	model_cc_tmp_stream << "}\n";
model_cc_tmp_stream<<"\n";
	model_cc_tmp_stream << "Json::Value ";
{
